...
{
    public class ProcSupplier
    {
        private readonly EnsuenoContext context;
        public ProcSupplier()
        {
            context = new EnsuenoContext();
        }
        ...
        public async Task<string> DeleteSupplier(Suppliers supplier)
        {
            try
            {
                var suppli = await context.Suppliers.FindAsync(supplier.SupplierId);
        ...
        public async Task<List<SupplierDTO>> GetListSuppliers()
        {
            try
            {
        ...
        public async Task<List<SupplierDTO>> SearchSuppliers(Suppliers supplier)
        {
            try
            {
                var supplierList = await (from s in context.Suppliers
        ...
        public async Task<Suppliers> GetSupplier(Suppliers supplier)
        {
            try
            {
                var suppli= await context.Suppliers.FindAsync(supplier.SupplierId);
